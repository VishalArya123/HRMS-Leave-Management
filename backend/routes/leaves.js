...
// Submit new leave request - FIXED SQL QUOTES
router.post('/', authMiddleware, async (req, res) => {
  try {
    ...
    if (emp.role === 'employee') {
      ...
      // FIXED: Use single quotes for 'admin'
    ...
    // Check annual LOP limit - FIXED: Use single quotes for 'approved'
    ...
    // Insert leave request - FIXED: Use single quotes for 'pending'
...
// Cancel leave request - FIXED SQL QUOTES
router.post('/:id/cancel', authMiddleware, async (req, res) => {
  try {
    ...
    // FIXED: Use single quotes for 'pending'
    ...
    // FIXED: Use single quotes for 'cancelled'
...
// Approve or reject leave - FIXED SQL QUOTES
router.post('/:id/decision', authMiddleware, async (req, res) => {
  try {
    ...
    if (action === 'approve') {
      // FIXED: Use single quotes for 'approved'
      ...
      // FIXED: Use single quotes for 'rejected'
